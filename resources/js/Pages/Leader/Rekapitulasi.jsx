...
export default function Index({ achievements, from, to,auth }) {
    ...
    // const exportExcel = (e) =>{
    //     e.preventDefault();
    //     get(route("leader.rekapitulasi.excel"))
    // }

    // const printSubmit = (e) =>{
    //     e.preventDefault();
    //     get(route("leader.rekapitulasi.print"))
    // }
                        ...
                        {achievements && (
                            ...
                            <div className="flex items-center gap-3">
                                    {/* <form onSubmit={printSubmit}>
                                        <PrimaryButton type="submit" className="bg-orange-500 hover:bg-orange-500 focus:bg-orange-600 active:bg-orange-600 focus:ring-orange-400" text="PRINT"/>
                                    </form> */}
                                    <div className="px-2 py-2 bg-red-500 rounded text-white font-medium hover:bg-red-700 focus:bg-red-700 active:bg-red-600 focus:ring-red-400">
                                     <a href="/leader/cetak_pdf" className="btn btn-primary" target="_blank">CETAK PDF</a>
                                     </div>
                                     {/* <form onSubmit={excelSubmit}>
                                        <PrimaryButton type="submit" className="bg-orange-500 hover:bg-orange-500 focus:bg-orange-600 active:bg-orange-600 focus:ring-orange-400" text="CETAK EXCEL"/>
                                    </form> */}
                                    {/* <Link href ={route("leader.rekapitulasi.print")}>
                                        <PrimaryButton className="bg-orange-500 hover:bg-orange-500 focus:bg-orange-600 active:bg-orange-600 focus:ring-orange-400" text="PDF"/>
                                    </Link> */}
                                    ...
                                    <Dropdown>
                                        ...
                                        <Dropdown.Content>
                                            ...
                                            <Dropdown.Link
                                                ...
                                                href=""
                                            >
                                                {/* <form onSubmit={exportExcel} className="container flex gap-3">
                                                    ...
                                                    <a  type="submit" className="justify-center">EXCEL</a>
                                                </form> */}
                                            </Dropdown.Link>
                                        </Dropdown.Content>
                                </Dropdown>
