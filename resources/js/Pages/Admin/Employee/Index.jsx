...
export default function index({ users, auth }) {
    ...
    const cetak_pdf_employee = (e) =>{
        e.preventDefault();
        const url = route("admin.cetak_pdf_employee") + "?" + new URLSearchParams(data).toString();
        window.location.href = url;
    };
    const cetak_excel_employee = (e) =>{
        e.preventDefault();
        const url = route("admin.cetak_excel_employee") + "?" + new URLSearchParams(data).toString();
        window.location.href = url;
    };
    const columns = [
        {
            ...
            <Authenticated>
                ...
                <div className="w-screen">
                    <div className="flex justify-end px-10 pt-3 ">
                        ...
                        <div className="">
                        <Link onClick={cetak_excel_employee}
