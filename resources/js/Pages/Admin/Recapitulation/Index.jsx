...
export default function Index({ achievements, userAchievements, from, to, auth,flashMessage }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        get(route("admin.recapitulation.index"));
    };
    ...
    const handlePrint = () => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const newWindow = window.open(`/admin/achievement/recapitulation/print/?${queryString}`);
            newWindow.focus();
          }
        });
    };
    ...
    const handleExportPdf = () => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const queryString = queryParams.toString();
            const newWindow = window.open(`/admin/achievement/recapitulation/export/pdf/?${queryString}`);
            newWindow.focus();
          }
        });
    };
    ...
    const handleExportExcel = () => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const queryString = queryParams.toString();
            const newWindow = window.open(`/admin/achievement/recapitulation/export/excel/?${queryString}`);
            newWindow.focus();
          }
        });
    };
