...
export default function Index({ achievements, from, to,auth }) {
    ...
    const pdfSubmit = (e) => {
        e.preventDefault();
        const url = route("leader.cetak_pdf_detail") + "?" + new URLSearchParams(data).toString();
                 ...
                 <div className="flex justify-between px-10 pt-2 ">
                                ...
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        <Dropdown.Link
                                            ...
                                            <div className="">
                                                <Link
                                              onClick={pdfSubmit}                                                className="w-full flex gap-3 justify-start bg-transparent">
                    ...
                    <div className="px-10 pt-4">
                        ...
                        />
                            ...
                            <p className="w-full py-6 text-center bg-red-500 text-white">Filter terlebih dahulu</p>
                        )}
                    </div>
                </div>
                </div>
