...
export default function Index({ achievements, userAchievements, from, to, auth,flashMessage }) {
    ...
    const filteredData = Object.values(userAchievements)
        .filter((row) =>
    ...
    const submit = (e) => {
        e.preventDefault();
        get(route("leader.recapitulation.index"));
    };
    ...
    const handlePrint = () => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const newWindow = window.open(`/leader/achievement/recapitulation/print/?${queryString}`);
            newWindow.focus();
          }
        });
    };
    ...
    const handleExportPdf = () => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const queryString = queryParams.toString();
            const newWindow = window.open(`/leader/achievement/recapitulation/export/pdf/?${queryString}`);
            newWindow.focus();
          }
        });
    };
    ...
    const handleExportExcel = () => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const queryString = queryParams.toString();
            const newWindow = window.open(`/leader/achievement/recapitulation/export/excel/?${queryString}`);
            newWindow.focus();
          }
        });
    };
                ...
                <div className="w-screen">
                    ...
                    <div className="pt-4 container mx-auto  ">
                        <div className="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                            <DataTable
                                title="Achievement Recapitulation"
                                columns={columns}
