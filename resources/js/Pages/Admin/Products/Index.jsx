...
row.target === parseInt(filterText, 10)
    ...
    const cetak_pdf_product = (e) =>{
        e.preventDefault();
        const url = route("admin.cetak_pdf_product") + "?" + new URLSearchParams(data).toString();
        window.location.href = url;
    };
    const cetak_excel_product = (e) =>{
        e.preventDefault();
        const url = route("admin.cetak_excel_product") + "?" + new URLSearchParams(data).toString();
        window.location.href = url;
    };
    ...
    return (
        <>
            <Authenticated>
                ...
                <div>
                <div className="">
                        <Link onClick={cetak_excel_product}
