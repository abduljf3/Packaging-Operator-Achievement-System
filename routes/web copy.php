...
Route::get('/cetak_pdf', [LeaderController::class,'cetak_pdf'])->name('leader.cetak_pdfs');
});


Route::prefix('admin')->middleware(['auth'])->group(function () { 
    Route::resource('products',ProductController::class)->name('index','products.index');
    Route::resource('achievement',\App\Http\Controllers\Admin\AchievementController::class)->name('index','achievement.index','admin.achievement.index');
