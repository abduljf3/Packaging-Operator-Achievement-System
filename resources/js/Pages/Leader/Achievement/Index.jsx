...
export default function Index({ achievements, from, to, auth,flashMessage }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        get(route("leader.achievement.index"));
    };
    ...
    const handlePrint = () => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const newWindow = window.open(`/leader/achievement/print/detail/?${queryString}`);
            newWindow.focus();
          }
        });
    };
    ...
    const handleExportPdf = () => {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            const queryString = queryParams.toString();
            const newWindow = window.open(`/leader/achievement/export/pdf/detail/?${queryString}`);
            newWindow.focus();
          }
        });
    };
